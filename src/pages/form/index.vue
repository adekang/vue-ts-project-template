...
import { ref } from 'vue'
import type { FormInstance, FormOptions } from '@/components/pro-form/types'
import MForm from '@/components/pro-form/index.vue'
...
const options: FormOptions[] = [
  ...
  },
  {
    ...
    prop: 'pic',
    uploadAttrs: {
      action: 'https://run.mocky.io/v3/f99dcacf-9c5e-46c7-9576-da692b91d292',
      multiple: true,
      limit: 3,
    },
    rules: [
...
function handleBeforeUpload(val: any) {
